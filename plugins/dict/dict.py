...
class DictPlugin(ParsingPluginTemplate):
    def __init__(self, bot):
        ...
        super(DictPlugin, self).__init__(bot, command=self._config.get('dict','command', fallback="dict"), description="Keys and values! Intended to be used for copypasta.")


        self._filename = "{datapath}{filename}".format(datapath=self._bot.get_base_data_path(), filename=self._config.get("dict",'savefilename', fallback="dictplugindata.json"))
        self._options = []
